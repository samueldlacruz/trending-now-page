...
const Search = () => {
    ...
    return (
        <div className="mt-4 flex w-full">
            ...
            <button aria-label="Search" onClick={() => dispatch(searchByQuery(terms))} className="bg-red-700 hover:bg-red-800 cursor-pointer text-white rounded-sm ml-2 py-2 px-4">
